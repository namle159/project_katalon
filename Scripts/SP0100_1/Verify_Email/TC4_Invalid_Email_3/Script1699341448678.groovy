...
'Input invalid email have multiple @'
WebUI.setText(findTestObject('Text_Box_Page/Page_DEMOQA/input_Email_userEmail'), Email)

CustomKeywords.'ui.UIResources.TakeScreenshot'('TC4_Invalid_Email_3_ss007.png')
...
CustomKeywords.'ui.UIResources.TakeScreenshot'('TC4_Invalid_Email_3_ss008.png')
