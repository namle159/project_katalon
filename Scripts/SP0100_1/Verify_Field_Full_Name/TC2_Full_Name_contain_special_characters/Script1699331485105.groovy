...
'Input field Full Name contain special characters'
WebUI.setText(findTestObject('Object Repository/Text_Box_Page/Page_DEMOQA/input_Full Name_userName'), FullName)

CustomKeywords.'ui.UIResources.TakeScreenshot'('TC2_Full_Name_contain_special_characters_ss012.png')

WebUI.click(findTestObject('Object Repository/Text_Box_Page/Page_DEMOQA/button_Submit'))

CustomKeywords.'ui.UIResources.TakeScreenshot'('TC2_Full_Name_contain_special_characters_ss013.png')
